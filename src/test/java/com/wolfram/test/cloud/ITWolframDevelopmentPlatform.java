...
public class ITWolframDevelopmentPlatform extends AbstractSeleniumTestBase {
	...
	/** Saves a screenshot of the report generated by ReportNG */
	@AfterSuite
	private void saveReportNGScreenshot() {
		// Navigate the driver to the generated ReportNG page
		this.driver.get("./test-output/index.html");
		
		// Take a screenshot of the generated report
		this.takeScreenshotOfPage("./test-output/reportHtmlScreenshot.png");
